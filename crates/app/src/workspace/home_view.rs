...
impl Workspace {
    pub(super) fn render_home(
        ...
        if self.connecting {
            main = main.flex().items_center().justify_center().child(
                v_flex()
                    .items_center()
                    .gap_2()
            ...
            if let Some(form) = &self.form {
                main = main.child(div().w(px(560.0)).mt_8().mx_auto().child(form.clone()));
            } else {
    ...
    pub(super) fn render_home_welcome(
        &self,
        main: Stateful<Div>,
        cx: &mut Context<Self>,
    ) -> Stateful<Div> {
        main.flex().items_center().justify_center().child(
            v_flex()
                .items_center()
                .justify_center()
                .gap_1()
